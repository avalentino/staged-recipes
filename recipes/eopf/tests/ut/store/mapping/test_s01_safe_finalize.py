...
def test_build_coordinates():
    ...
    azimuth_time, ground_range = build_coordinates(additional_info, "ground_range")
    azimuth_time, slant_range_time = build_coordinates(additional_info, "slant_range_time")

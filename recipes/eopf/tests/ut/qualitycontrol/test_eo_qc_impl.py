...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            r"PASSED: other_metadata/datatake_type:INS-NOBS is in the possible list \['INS-NOBS'\]",
        ),
        (
            "attr_in_list",
            check_data("failed_attr_in_list"),
            False,
            r"FAILED: other_metadata/datatake_type:INS-NOBS is not in the possible list \['INS-DASC'\]",
        ),
        (
            "attr_matches",
            check_data("passed_attr_match"),
            True,
            r"PASSED: other_metadata/datatake_type value INS-NOBS is matching the pattern INS-\[A-Z\]\{4\}",
        ),
        (
            "attr_matches",
            check_data("failed_attr_match"),
            False,
            r"FAILED: other_metadata/datatake_type value INS-NOBS is not matching the pattern \[a-z\]\*",
        ),
        (
            "attr_exists",
